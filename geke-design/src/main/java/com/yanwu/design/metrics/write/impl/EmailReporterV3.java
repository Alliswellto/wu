...
public class EmailReporterV3 extends ScheduleReporter {
    ...
    public EmailReporterV3(List<String> emailToAddresses) {
        this(new RedisMetricsStorage(), new AggregatorV2(), new EmailViewer(emailToAddresses));
    }

    public EmailReporterV3(MetricsStorage metricsStorage, AggregatorV2 aggregator, StatViewer viewer) {
